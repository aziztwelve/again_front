<template>
  <button class="product__actions-cart btn _bell" @click="openRestockNotify">
    <svg class="product__actions-bell" width="18" height="20" viewBox="0 0 18 20" fill="none"
