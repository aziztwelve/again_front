  ...
  <div class="cart__promotion-item">
    <div class="cart__promotion-header">
      ...
      <div class="cart__promotion-info">
        <div class="cart__promotion-title">{{ promotion.name }}</div>
        <div v-if="promotion.description" class="cart__promotion-desc">
      ...
      <div class="cart__promotion-gifts-list">
        ...
        >
          ...
          >
            ...
            <div v-if="selectedGiftId === gift.id" class="cart__promotion-gift-check">✓</div>
          </div>

          <!-- Выбор варианта: шаг 1 — цвет, шаг 2 — размер -->
          <div
              v-if="selectedGiftId === gift.id && gift.has_variants"
          ...
          >
            <template v-if="gift.variants && gift.variants.length > 0">
              ...
              <template v-if="uniqueColors(gift).length > 0">
                ...
                <div class="cart__promotion-gift-colors">
                  <button
                      ...
                      :class="{ '_selected': promotionStore.selectedColorIdFor(promotion.id, gift.id) === color.id }"
                      :title="color.name"
                      @click="promotionStore.selectGiftColor(promotion.id, gift, color.id)"
                  >
                    <span
              ...
              <template v-if="promotionStore.selectedColorIdFor(promotion.id, gift.id) || uniqueColors(gift).length === 0">
                ...
                <div class="cart__promotion-gift-variants-list">
                  <button
                      ...
                      :class="{ '_selected': promotionStore.selectedVariantIdFor(promotion.id, gift.id) === variant.id }"
                      @click="promotionStore.selectGiftVariant(promotion.id, gift, variant)"
                  >
              ...
              <div
                  v-if="!promotionStore.selectedVariantIdFor(promotion.id, gift.id)"
